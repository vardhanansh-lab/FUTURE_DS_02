...
customer\_churn\_analysis.ipynb → Python analysis notebook

telco\_churn.xlsx → Dataset

churn\_distribution.png → Visualization

contract\_churn.png → Visualization
